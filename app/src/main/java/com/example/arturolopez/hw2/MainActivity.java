...
//                    ld.getLocation = ja.getJSONObject(i).getDouble("third");
                    ld.getTime = ja.getJSONObject(i).getString("forth");
                    ld.getDate = ja.getJSONObject(i).getString("fifth");
                    ld.getLong = ja.getJSONObject(i).getDouble("long_String");
                    ld.getLat = ja.getJSONObject(i).getDouble("lat_string");
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    //detailIntent.putExtra("third", selected.getLocation);
                    detailIntent.putExtra("forth", selected.getTime);
                    detailIntent.putExtra("fifth", selected.getDate);
                    detailIntent.putExtra("long_string", selected.getLong);
                    detailIntent.putExtra("lat_string", selected.getLat);
